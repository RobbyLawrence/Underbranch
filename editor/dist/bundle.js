            ...
            /***/ (
                ...
                const App = () => {
                    ...
                    const [latexCode, setLatexCode] =
                        useState(`\\documentclass{article}
...
\\end{document}`);
                    ...
                    const handleCompile = async () => {
                        try {
                            ...
                            const url =
                                URL.createObjectURL(blob) + `#${Date.now()}`;
                            // clean up old blobs
                            setPdfUrl((prevUrl) => {
            ...
            /***/ () => {
                ...
                class Collaborative {
                    ...
                    async getUserInfo() {
                        ...
                        let userColor = localStorage.getItem(
                            "collaborativeUserColor",
                        );
                        if (!userName) {
                            userName =
                                prompt(
                                    "Enter your name for collaborative editing:",
                                ) || `User ${Date.now()}`;
                    ...
                    async promptForRoom() {
                        const roomId =
                            prompt(
                                'Enter room name to join (or leave empty for "general"):',
                            ) || "general";
                        if (roomId === "general") {
                        ...
                        return new Promise((resolve) => {
                            const checkEditor = () => {
                                ...
                                if (window.monaco) {
                                    ...
                                    if (
                                        editorElement &&
                                        editorElement._monacoEditor
                                    ) {
                                        console.log(
                                            "Found editor on element._monacoEditor",
                                        );
                                        this.editor =
                                            editorElement._monacoEditor;
                                        resolve();
                                    ...
                                    console.log(
                                        " Monaco global not available yet",
                                    );
                                }
                                console.log(
                                    "Editor not ready yet, retrying...",
                                );
                    ...
                    setupCollaboration() {
                        if (!this.editor) {
                            console.error(
                                "            const socket = io('https://underbranch.org');Monaco editor not found",
                            );
                            return;
                        }
                        ...
                        this.editor.onDidChangeModelContent((e) => {
                            if (!this.isUpdatingFromRemote) {
                                ...
                                console.log(
                                    "Skipping broadcast - change from remote",
                                );
                            }
                        });
                    ...
                    updateDocumentContent(content) {
                        if (this.editor && this.editor.getValue() !== content) {
                            ...
                            console.log(
                                "Content already up to date, skipping update",
                            );
                        }
                    }
...
`;
  ...
  \****************************/
            /***/ (
                ...
                /* harmony import */ var _latexCommands_js__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                        /*! ./latexCommands.js */ "./src/latexCommands.js",
                    );
                                        ...
                                        "latex",
                                        {
                                            ...
                                            provideCompletionItems: (
                                                ...
                                                if (commandMatch) {
                                                    ...
                                                    const suggestions =
                                                        _latexCommands_js__WEBPACK_IMPORTED_MODULE_0__.latexCommands
                                                            .filter((cmd) =>
                                                            ...
                                                            .map((cmd) => {
                                                                ...
                                                                if (
                                                                    ...
                                                                    endColumn =
                                                                        position.column +
                                                                        1; // Include the closing brace in replacement
                                                                }
                                                                return {
                                                                    label: cmd.command,
                                                                    kind: monaco
                                                ...
                                                if (beginMatch) {
                                                    ...
                                                    const suggestions =
                                                        _latexCommands_js__WEBPACK_IMPORTED_MODULE_0__.latexEnvironments
                                                            .filter((env) =>
                                                                env.startsWith(
                                                                    partialEnv,
                                                                ),
                                                            ...
                                                            .map((env) => {
                                                                ...
                                                                if (
                                                                    ...
                                                                    endColumn =
                                                                        position.column +
                                                                        1; // Replace up to and including the }
                                                                } else {
                                    ...
                                    monaco.languages.registerCompletionItemProvider(
                                        "latex",
                                        {
                                            ...
                                            provideCompletionItems: (
                                                ...
                                                if (
                                                    _latexCommands_js__WEBPACK_IMPORTED_MODULE_0__.latexEnvironments.includes(
                                                        environmentName,
                                                    )
                                                ) {
                                                    return {
                                                ...
                                                for (
                                                    ...
                                                    if (
                                                        ...
                                                        return {
                                                            suggestions: [],
                                                        }; // Found matching \end{}, don't suggest
                                                    }
                                                }
                                                return {
                                                    suggestions: [
            ...
            /***/ (
                ...
                const Toolbar = ({
                    ...
                    const handleDownloadPDF = () => {
                        if (!pdfUrl) {
                            alert(
                                "No compiled PDF available. Please compile first.",
                            );
                            return;
                        }
                        const a = document.createElement("a");
  ...
  \******************************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ latexCommands: () =>
                            /* binding */ latexCommands,
                        /* harmony export */ latexEnvironments: () =>
                            /* binding */ latexEnvironments,
                        /* harmony export */
                    },
                );
                ...
                const latexCommands = [
                    ...
                    },
                    {
                        ...
                        insertText: "subparagraph{$0}",
                        documentation: "Subparagraph",
                    },
                    // Text formatting
                    {
                        command: "textbf",
                    ...
                    // Font sizes
                    {
                        command: "tiny",
                        insertText: "tiny ",
                        documentation: "Tiny font size",
                    },
                    {
                        command: "scriptsize",
                        insertText: "scriptsize ",
                        documentation: "Script font size",
                    },
                    {
                        command: "footnotesize",
                        insertText: "footnotesize ",
                        documentation: "Footnote font size",
                    },
                    {
                        command: "small",
                        insertText: "small ",
                    ...
                    },
                    {
                        ...
                        documentation: "Normal font size",
                    },
                    {
                        command: "large",
                        insertText: "large ",
                    ...
                    },
                    {
                        command: "Large",
                        insertText: "Large ",
                        documentation: "Larger font size",
                    },
                    {
                        command: "LARGE",
                        insertText: "LARGE ",
                        documentation: "Even larger font size",
                    },
                    {
                        command: "huge",
                        insertText: "huge ",
                        documentation: "Huge font size",
                    },
                    {
                        command: "Huge",
                        insertText: "Huge ",
                        documentation: "Hugest font size",
                    },
                    // Document metadata
                    {
                        command: "title",
                    ...
                    },
                    {
                        command: "partial",
                        insertText: "partial",
                        documentation: "Partial derivative",
                    },
                    {
                        command: "nabla",
                        insertText: "nabla",
                        documentation: "Nabla operator",
                    },
                    // Greek letters (lowercase)
                    {
                        command: "alpha",
                        insertText: "alpha",
                        documentation: "α (alpha)",
                    },
                    {
                        command: "beta",
                        insertText: "beta",
                        documentation: "β (beta)",
                    },
                    {
                        command: "gamma",
                        insertText: "gamma",
                        documentation: "γ (gamma)",
                    },
                    {
                        command: "delta",
                        insertText: "delta",
                        documentation: "δ (delta)",
                    },
                    {
                        command: "epsilon",
                        insertText: "epsilon",
                        documentation: "ε (epsilon)",
                    },
                    {
                        command: "varepsilon",
                        insertText: "varepsilon",
                        documentation: "ε (epsilon variant)",
                    },
                    {
                        command: "zeta",
                        insertText: "zeta",
                        documentation: "ζ (zeta)",
                    },
                    {
                        command: "eta",
                        insertText: "eta",
                    ...
                    },
                    {
                        command: "theta",
                        insertText: "theta",
                        documentation: "θ (theta)",
                    },
                    {
                        command: "vartheta",
                        insertText: "vartheta",
                        documentation: "θ (theta variant)",
                    },
                    {
                        command: "iota",
                        insertText: "iota",
                        documentation: "ι (iota)",
                    },
                    {
                        command: "kappa",
                        insertText: "kappa",
                        documentation: "κ (kappa)",
                    },
                    {
                        command: "lambda",
                        insertText: "lambda",
                        documentation: "λ (lambda)",
                    },
                    {
                        command: "mu",
                        insertText: "mu",
                    ...
                    },
                    {
                        command: "varrho",
                        insertText: "varrho",
                        documentation: "ρ (rho variant)",
                    },
                    {
                        command: "sigma",
                        insertText: "sigma",
                        documentation: "σ (sigma)",
                    },
                    {
                        command: "varsigma",
                        insertText: "varsigma",
                        documentation: "ς (sigma variant)",
                    },
                    {
                        command: "tau",
                        insertText: "tau",
                    ...
                    },
                    {
                        command: "mp",
                        insertText: "mp",
                        documentation: "∓ (minus-plus)",
                    },
                    {
                        command: "cdot",
                        insertText: "cdot",
                        documentation: "· (centered dot)",
                    },
                    {
                        command: "ast",
                        insertText: "ast",
                    ...
                    },
                    {
                        command: "ll",
                        insertText: "ll",
                        documentation: "≪ (much less than)",
                    },
                    {
                        command: "gg",
                        insertText: "gg",
                        documentation: "≫ (much greater than)",
                    },
                    // Logic
                    {
                        command: "forall",
                    ...
                    },
                    {
                        command: "supset",
                        insertText: "supset",
                        documentation: "⊃ (superset)",
                    },
                    {
                        command: "subseteq",
                        insertText: "subseteq",
                        documentation: "⊆ (subset or equal)",
                    },
                    {
                        command: "supseteq",
                        insertText: "supseteq",
                        documentation: "⊇ (superset or equal)",
                    },
                    {
                        command: "cup",
                        insertText: "cup",
                    ...
                    },
                    {
                        command: "emptyset",
                        insertText: "emptyset",
                        documentation: "∅ (empty set)",
                    },
                    {
                        command: "mathbb",
                        insertText: "mathbb{$0}",
                        documentation: "Blackboard bold (e.g., ℝ, ℕ)",
                    },
                    // Arrows
                    {
                        command: "leftarrow",
                    ...
                    },
                    {
                        command: "Leftarrow",
                        insertText: "Leftarrow",
                        documentation: "⇐ (double left arrow)",
                    },
                    {
                        command: "Rightarrow",
                        insertText: "Rightarrow",
                        documentation: "⇒ (double right arrow)",
                    },
                    {
                        command: "Leftrightarrow",
                        insertText: "Leftrightarrow",
                        documentation: "⇔ (double left-right arrow)",
                    },
                    // Delimiters
                    {
                        command: "left(",
                        insertText: "left( $0 \\right)",
                        documentation: "Auto-sized parentheses",
                    },
                    {
                        command: "left[",
                        insertText: "left[ $0 \\right]",
                        documentation: "Auto-sized brackets",
                    },
                    {
                        command: "left{",
                        insertText: "left\\{ $0 \\right\\}",
                        documentation: "Auto-sized braces",
                    },
                    {
                        command: "left|",
                        insertText: "left| $0 \\right|",
                        documentation: "Auto-sized vertical bars",
                    },
                    // References
                    {
                        command: "label",
                        insertText: "label{$0}",
                        documentation: "Label for reference",
                    },
                    {
                        command: "ref",
                        insertText: "ref{$0}",
                        documentation: "Reference to label",
                    },
                    {
                        command: "eqref",
                        insertText: "eqref{$0}",
                        documentation: "Equation reference",
                    },
                    {
                        command: "cite",
                        insertText: "cite{$0}",
                    ...
                    },
                    {
                        ...
                        insertText: "bibliography{$0}",
                        documentation: "Bibliography",
                    },
                    {
                        command: "bibliographystyle",
                        insertText: "bibliographystyle{$0}",
                        documentation: "Bibliography style",
                    },
                    // Lists
                    {
                        command: "item",
                    ...
                    // Tables
                    {
                        command: "hline",
                        insertText: "hline",
                        documentation: "Horizontal line in table",
                    },
                    {
                        command: "multicolumn",
                        insertText: "multicolumn{$1}{$2}{$3}",
                        documentation: "Multicolumn cell",
                    },
                    {
                        command: "multirow",
                        insertText: "multirow{$1}{$2}{$3}",
                        documentation: "Multirow cell",
                    },
                    // Theorems and proofs (amsthm package)
                    {
                        command: "newtheorem",
                        insertText: "newtheorem{$1}{$2}",
                        documentation: "Define new theorem environment",
                    },
                    {
                        command: "qed",
                        insertText: "qed",
                        documentation: "QED symbol",
                    },
                    {
                        command: "qedhere",
                        insertText: "qedhere",
                        documentation: "Place QED symbol here",
                    },
                ];
  ...
  \**********************/
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _Toolbar_js__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./Toolbar.js */ "./src/Toolbar.js");
        /* harmony import */ var _LaTeXEditor_js__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./LaTeXEditor.js */ "./src/LaTeXEditor.js");
        /* harmony import */ var _PreviewPane_js__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(/*! ./PreviewPane.js */ "./src/PreviewPane.js");
        /* harmony import */ var _App_js__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(/*! ./App.js */ "./src/App.js");
        /* harmony import */ var _Collaborative_js__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(
                /*! ./Collaborative.js */ "./src/Collaborative.js",
            );
        /* harmony import */ var _Collaborative_js__WEBPACK_IMPORTED_MODULE_4___default =
            /*#__PURE__*/ __webpack_require__.n(
                _Collaborative_js__WEBPACK_IMPORTED_MODULE_4__,
            );
        ...
        window.LaTeXEditor =
            _LaTeXEditor_js__WEBPACK_IMPORTED_MODULE_1__["default"];
        window.PreviewPane =
            _PreviewPane_js__WEBPACK_IMPORTED_MODULE_2__["default"];
