...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _latexCommands_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./latexCommands.js */ "./src/latexCommands.js");
const {
  useEffect,
  useRef
} = React;
        ...
        if (editorRef.current && !monacoRef.current) {
          ...
          monaco.languages.registerCompletionItemProvider("latex", {
            ...
            provideCompletionItems: (model, position) => {
              ...
              if (commandMatch) {
                ...
                const suggestions = _latexCommands_js__WEBPACK_IMPORTED_MODULE_0__.latexCommands.filter(cmd => cmd.command.startsWith(partialCommand)).map(cmd => {
              ...
              if (beginMatch) {
                ...
                const suggestions = _latexCommands_js__WEBPACK_IMPORTED_MODULE_0__.latexEnvironments.filter(env => env.startsWith(partialEnv)).map(env => {
          ...
          monaco.languages.registerCompletionItemProvider("latex", {
            ...
            provideCompletionItems: (model, position) => {
              ...
              if (_latexCommands_js__WEBPACK_IMPORTED_MODULE_0__.latexEnvironments.includes(environmentName)) {
                return {
                  suggestions: []
                };
              }
              ...
              const searchLimit = Math.min(position.lineNumber + 50, totalLines);
              const endPattern = `\\end{${environmentName}}`;
              for (let i = position.lineNumber; i <= searchLimit; i++) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   latexCommands: () => (/* binding */ latexCommands),
/* harmony export */   latexEnvironments: () => (/* binding */ latexEnvironments)
/* harmony export */ });
...
"document",
// Math environments
"equation", "equation*", "align", "align*", "gather", "gather*", "multline", "multline*", "split", "cases", "matrix", "pmatrix", "bmatrix", "Bmatrix", "vmatrix", "Vmatrix",
// Lists
"itemize", "enumerate", "description",
// Floats
"figure", "table",
// Text formatting
"center", "flushleft", "flushright", "quote", "quotation", "verse", "verbatim",
// Front matter
"abstract", "titlepage",
// Theorem-like environments (amsthm)
"theorem", "lemma", "proposition", "corollary", "conjecture", "definition", "example", "remark", "note", "proof", "claim", "axiom",
// Beamer
