...
const ROOT = path.join(__dirname, '../..'); // serve files relative to repo root (go up two directories)
...
const server = http.createServer((req, res) => {
  try {
    ...
    if (!safePath || safePath === '') {
      res.statusCode = 302;
      res.setHeader('Location', '/frontend/editor/index.html');
      res.end();
      return;
    }
...
server.listen(PORT, () => {
  ...
  console.log('📝 Open /frontend/editor/index.html to start collaborating!');
